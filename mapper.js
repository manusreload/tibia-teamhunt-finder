...
$('a[href*="'+minimap_mapper_page_match+'"]').click(function() { minimap_load($(this).attr('href')); return false; });
// Backward-compatibility for tibia.wikia.com.
$('a[href*="'+minimap_mapper_page_match_wikia+'"]').click(function() { minimap_load($(this).attr('href')); return false; });
